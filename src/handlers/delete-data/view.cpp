...
namespace cpp_reseller_backend {
    ...
    namespace {
        ...
        class DeleteData final : public userver::server::handlers::HttpHandlerBase {
        public:
            static constexpr std::string_view
            kName = "handler-delete-data";

            DeleteData(const userver::components::ComponentConfig &config,
    ...
    void AppendDeleteData(userver::components::ComponentList &component_list) {
        component_list.Append<DeleteData>();
    }
